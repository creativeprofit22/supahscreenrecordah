...
export const captionEditBtn = document.getElementById('caption-edit-btn') as HTMLButtonElement;
export const captionEditorModal = document.getElementById('caption-editor-modal') as HTMLDivElement;
export const captionEditorClose = document.getElementById('caption-editor-close') as HTMLButtonElement;
export const captionEditorList = document.getElementById('caption-editor-list') as HTMLDivElement;
